...
/**
 * Generates Obbz CRUD (Backend & Frontend)
 *
...
{
    public $templates = [
//        'default'=>'@vendor/obbz/yii2/gii/crud/default',
        'be'=>'@vendor/obbz/yii2/gii/crud/be',
    ];
    public $template = 'be';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['refererModel'], 'validateClass', 'params' => ['extends' => BaseActiveRecord::class]],
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
            ...
            else if (preg_match('/^(image|img)$/i', $column->name)) {
                return "\$form->field(\$model, '$attribute')->imgInput()";
            }
            else {
                $input = 'textInput';
            }
    ...
    public function generateCoreField($attribute)
    {
        $coreAttributes = CoreActiveRecord::getCoreAttributes();
    }
    ...
    public function generateActiveSearchField($attribute)
    {
        if($attribute === "disabled"){
            ...
            if ($column->phpType === 'boolean') {
                ...
                return "\$form->field(\$model, '$attribute')->disableFloatingLabel()";
            }
        }
